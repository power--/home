...
insert into gp_user(id,guid,createTime,email,password,phone,username,defaultUser)
values
(21,'29f6004fb1b0466f9572b02bf2ac1be8',now(),'admin@goparty.com','21232f297a57a5a743894a0e4a801fc3','028-1234567','admin',true);
